...
class LabelContentField extends StatefulWidget {
  ...
  @override
  State<LabelContentField> createState() => _LabelContentFieldState();
}

class _LabelContentFieldState extends State<LabelContentField> {
